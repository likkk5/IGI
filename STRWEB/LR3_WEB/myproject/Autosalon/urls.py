...
urlpatterns = [
    ...
    path('create_about_company/', views.create_about_company, name='create_about_company'),
    path('edit_about_company/<int:pk>/', views.edit_about_company, name='edit_about_company'),
    path('add_banner/<int:company_id>/', views.add_banner, name='add_banner'),
    ...
    path('plot/', views.plot_arcsin, name='plot_arcsin'),
]
