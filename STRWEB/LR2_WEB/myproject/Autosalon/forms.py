...
from .models import AboutCompany, Banner, Partner, ProductType
...
class AboutCompanyForm(forms.ModelForm):
    class Meta:
        model = AboutCompany
        # fields = ['name', 'logo', 'website', 'video_url', 'video_file', 'history', 'details', 'requisites', 'certificate']
        fields = ['name', 'logo']

        # Добавим настройки для отображения формы
        widgets = {
